...
class Tomato:
    ...
    states = {0: 'ничего нет', 1: 'цветение', 2: 'зеленый помидор', 3: 'красный помидор'}
...
class Gardener:
    ...
    # Выдаем садовнику помидоры для ухода
    ...
    def harvest(self):
        ...
        if self._plant.all_are_ripe():
            ...
            print('Садовник собрал помидоры')
        else:
            print('Слишком рано, помидоры не созрели.')
